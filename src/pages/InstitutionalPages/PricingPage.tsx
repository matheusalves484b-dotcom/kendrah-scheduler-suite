        ...
        <section className="bg-gradient-to-b from-white to-purple-50 py-16 px-4">
          <div className="container mx-auto text-center max-w-3xl">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Um único plano com tudo o que você precisa
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="flex flex-col md:flex-row gap-8 justify-center">
              ...
              <Card className="border border-kendrah-purple bg-white shadow-lg w-full max-w-md relative overflow-hidden">
                <div className="absolute top-0 right-0 bg-kendrah-purple text-white px-4 py-1 text-sm font-medium">
                  Recomendado
                </div>
                <CardHeader className="text-center">
                ...
                <CardFooter className="flex justify-center">
                  <Link to="/register">
                    <Button className="bg-kendrah-purple hover:bg-kendrah-purple/90 text-white w-full">
                      Assinar Agora
                    </Button>
                  </Link>
                </CardFooter>
            ...
            <div className="mt-12 text-center">
              <h3 className="text-2xl font-bold mb-4">Perguntas sobre nossos planos?</h3>
              <p className="text-gray-600 mb-6">Entre em contato conosco ou consulte nossa página de perguntas frequentes</p>
