...
const TrialBanner = ({ trialEndDate, isSubscribed }: TrialBannerProps) => {
      ...
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center text-sm">
        ...
        <div className="flex items-center mt-2 sm:mt-0">
          <Link to="/subscription">
            <Button size="sm" variant="outline" className="text-xs h-8 border-white text-white hover:bg-white hover:text-kendrah-purple mr-2">
              Assinar R$ 39,90/mês
            </Button>
          </Link>
          <button 
