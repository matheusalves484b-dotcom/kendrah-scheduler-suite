...
serve(async (req) => {
  ...
  try {
    ...
    const priceId = "price_1UC0apCvDOqSNbLdtf6cSLNq";
    ...
    logStep("Checkout session created", { sessionId: session.id, priceId, stripeMode: stripeKey.startsWith("sk_live_") ? "live" : "test" });
