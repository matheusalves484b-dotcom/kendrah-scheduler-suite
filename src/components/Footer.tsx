...
const Footer = () => {
  ...
  return (
    <footer className="bg-kendrah-black text-white py-12 mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/features" className="text-gray-300 hover:text-white transition-colors">Funcionalidades</Link></li>
              ...
              <li><Link to="/register" className="text-gray-300 hover:text-white transition-colors">Teste Grátis</Link></li>
            </ul>
          </div>
