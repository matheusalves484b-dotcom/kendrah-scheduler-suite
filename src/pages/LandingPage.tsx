          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2 lg:pr-10 mb-10 lg:mb-0">
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <Link to="/login">
                  <Button variant="outline" className="text-lg text-white border-white hover:bg-white/10 px-8 py-6">
                    Área do Cliente
                  </Button>
                </Link>
              </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {[
              ...
              <div key={index} className="kendrah-card flex flex-col items-center text-center hover:border-kendrah-purple/40 transition-colors">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="kendrah-card">
