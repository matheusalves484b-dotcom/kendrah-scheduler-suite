  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        if (error.message.includes('APPOINTMENT_CONFLICT')) {
          toast({
            ...
            description: 'Já existe um agendamento nesse horário. Escolha outro.',
            variant: 'destructive',
          });
          return;
        }
      ...
      toast({
        ...
        description: `${form.name} foi agendado com sucesso.`,
      });
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[520px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Crie um agendamento manualmente para o seu cliente.</DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            {services.length === 0 && (
              <p className="text-xs text-muted-foreground">
                Cadastre um serviço antes de criar agendamentos.
              </p>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input id="email" type="email" value={form.email} onChange={(e) => handleChange('email', e.target.value)} placeholder="cliente@email.com" />
            </div>
            <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Textarea id="notes" value={form.notes} onChange={(e) => handleChange('notes', e.target.value)} placeholder="Opcional" rows={3} />
          </div>
          ...
          <DialogFooter className="gap-2">
            ...
            <Button type="submit" className="bg-kendrah-purple hover:bg-kendrah-purple/90" disabled={saving}>
